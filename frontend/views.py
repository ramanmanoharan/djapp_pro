...
from .models import Metadatas, ContactDetails, ContactMessage, Footer, Work, Whoweare, Blog, About, Profile, Resume
from django.shortcuts import render
...
def profile(request):
	ProfileHome = ContactDetails.objects.all()
	ProfileFooter = Footer.objects.all()
	Profilemeta = Metadatas.objects.all()
	Profile = Resume.objects.all()
	return render(request, 'profile.html', {'Homemessage':ProfileHome, 'Foot':ProfileFooter, 'Metadat':Profilemeta, 'Profiles':Profile})